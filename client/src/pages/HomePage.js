      ...
      <div className="filters">
        ...
        <div className="filter-tab ">
          ...
          <Select value={type} onChange={(values) => setType(values)}>
            ...
            <Select.Option value="to be sold">TO BE SOLD</Select.Option>
          </Select>
        </div>
